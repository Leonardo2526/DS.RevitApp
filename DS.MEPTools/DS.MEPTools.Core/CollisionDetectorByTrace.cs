...
namespace DS.MEPTools.Core
{
    ...
    public class CollisionDetectorByTrace : ITraceCollisionDetector<Point3d>
    {
        ...
        private readonly ISolidOffsetExtractor _solidExtractor;
        ...
        /// <param name="solidOffsetExtractor"></param>
        ...
        public CollisionDetectorByTrace(Document doc, MEPCurve baseMEPCurve, ITraceSettings traceSettings, 
            IElementCollisionDetector collisionDetector, ISolidOffsetExtractor solidOffsetExtractor, IPoint3dConverter pointConverter = null,
            ITransactionFactory transactionFactory = null)
        {
            ...
            _solidExtractor = solidOffsetExtractor;
        }
        ...
        public List<(object, object)> GetCollisions(Point3d point1, Point3d point2, Basis3d basis)
        {
            ...
            var checkSolid = _solidExtractor.Extract(p1, p2, uCS1Basis);
            ...
            {
                var ruleCollisionFilter = GetFilter(_doc, direction, checkSolid, Logger, TransactionFactory);
                collisions = collisions.SkipWhile(ruleCollisionFilter).Where(c => c.Item2 is Wall).ToList();
    ...
    Point3d firstPoint, Point3d lastPoint, int tolerance = 3)
         ...
         ITransactionFactory trf)
        {
            ...
            {
                SolidElementRulesFilterSet.WallTraversableDirectionRule(doc, uCS1dir),
