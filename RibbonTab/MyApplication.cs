...
namespace DS.RevitApp.RibbonTab
{
    public class MyApplication : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var button4Path = Environment.ExpandEnvironmentVariables(@"%AppData%\Autodesk\Revit\Addins\2020\DS.AddSharedParameters\DS.AddSharedParameters.dll");
            ...
            PushButtonData button4 = new PushButtonData("Button4", "AddSharedParameters", button4Path, "AddSharedParameters.EntryCommand");
            ...
            projectButtons.AddRange(m_projectPanel_2.AddStackedItems(button3, button4));
