...
namespace DS.RevitApp.RibbonTab
{
    public class MyApplication : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButtonData button1 = new PushButtonData("Button1", "DS_RVTtoNWC.v1.2", button1Path, "DS.RevitApp.RVTtoNWC.DS_MainClass");
            PushButtonData button2 = new PushButtonData("Button2", "DS_FamiliesUpdate.v2", button2Path, "DS.RevitApp.FamiliesUpdate.EntryCommand");


            // Create a ribbon panel
            RibbonPanel m_projectPanel_1 = application.CreateRibbonPanel(tabName, "Panel_1");
