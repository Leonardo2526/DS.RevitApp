...
namespace DS_RVTtoNWC
{
...

    {
        ...
        {
            //Directory name write to log
            //dS_Tools.DS_StreamWriter(dir);
            ...
            foreach (string FileName in FileFullNames_Filtered)
            {
                ...
                string dirName = GetDirNWC(NWCFileName, dS_Tools);
               
                    // Get a reference to each file in that directory.
                    OutputPath = DestinationPath + "\\" + dirName + "\\";

                NWC_Export(uiapp, FileName, OutputPath, NWCFileName);              
            }
        }
        ...
        public void NWC_Export(UIApplication uiapp, string FileName, string OutputPath, string NWCFileName)
        {
        ...
        public string GetDirNWC(string NWCFileName, DS_Tools dS_Tools)
        //Output files names list and it's direcories to Log
        {
            try
            {
                ...
                foreach (string dirname in DirNWClist)
                {
                    ...
                    {
                        Directory.CreateDirectory(DestinationPath + "\\" + NWCFileName + "\\");
                        NewDirNWClist.Add(DestinationPath + "\\" + NWCFileName + "\\");
                        return NWCFileName;
                    }                       
                }
            }
